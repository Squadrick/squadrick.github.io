...
the mutex and reset the field of previous owner.
...
on this as an altervative robust IPC lock, and I'll make a blog post when I'm done.

2. Using a centralized process for tracking of processes. We register
